class DentalAnalyzer {
    constructor() {
        ...
        this.supportedTypes = ['image/jpeg', 'image/png', 'image/jpg'];
    }
    ...
    async handleFiles(files) {
        const validFiles = Array.from(files).filter(file => {
            ...
            if (file.size > this.maxFileSize) {
                this.showError(`File "${file.name}" exceeds maximum size of 16MB`);
                return false;
            }
        ...
        try {
            ...
            for (let i = 0; i < imagesToAnalyze.length; i++) {
                try {
                    ...
                    // Create image URL from server path
                    result.imageUrl = window.location.origin + result.image_path;
    ...
    displayResult(result) {
        try {
                ...
                <div class="analysis-card">
                    <div class="analysis-header">
                        ...
                        <div class="analysis-image-container">
                            <img src="${imageUrl}" alt="Dental X-Ray" class="analysis-image">
                    ...
                    <div class="diagnosis-section">
                        <div class="diagnosis-header">
                            <div class="diagnosis-title-wrapper">
                                <h3 class="diagnosis-title">
                                    <i class="fas fa-microscope"></i>
                                    ${result.predictions[0][0]}
                                </h3>
                                <span class="diagnosis-subtitle">Primary Diagnosis</span>
                            </div>
                    ...
                    <div class="analysis-content">
                        <div class="findings-section">
                            <h4 class="section-header">
                                ...
                                Clinical Findings
                                <span class="count-badge">${result.findings ? result.findings.length : 0}</span>
                            </h4>
                            <div class="findings-list">
                                ...
                                `).join('') : '<p class="no-data">No findings available</p>'}
                            </div>
                        </div>
                        ...
                        <div class="recommendations-section">
                            <h4 class="section-header">
                                ...
                                Recommendations
                                <span class="count-badge">${result.recommendations ? result.recommendations.length : 0}</span>
                            </h4>
                            <div class="recommendations-list">
                                ...
                                `).join('') : '<p class="no-data">No recommendations available</p>'}
                            </div>
                        </div>
                        ...
                        ${result.management ? `
                            <div class="management-section">
                                <h4 class="section-header">
                                    ...
                                    Management Plan
                                    <span class="count-badge">${Object.keys(result.management).length}</span>
                                </h4>
                                <div class="management-list">
                                    ${Object.entries(result.management).map(([key, value]) => `
                                        <div class="management-item">
                                            <div class="management-key">
                                                <i class="fas fa-chevron-right"></i>
                                                <strong>${key}</strong>
                                            </div>
                                            <div class="management-value">${value}</div>
                                        </div>
                                    `).join('')}
                                </div>
                            </div>
                    ...
                    <div class="card-actions">
                        <button class="action-icon" title="Export Report" onclick="exportSingleReport(${this.cases.length - 1})">
                            <i class="fas fa-file-export"></i>
                        </button>
                        <button class="action-icon" title="Share Analysis">
                            <i class="fas fa-share-alt"></i>
                        </button>
                        <button class="action-icon print-btn" title="Print Report">
            ...
            const imgContainer = card.querySelector('.analysis-image-container');
            const img = imgContainer.querySelector('.analysis-image');
            let rotation = 0;
            ...
            // Add click outside to close zoom
            imgContainer.addEventListener('click', (e) => {
                if (e.target === imgContainer && imgContainer.classList.contains('zoomed')) {
